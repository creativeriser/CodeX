    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-primary py-24 md:py-36 relative overflow-hidden">
        ...
        >
          ...
          >
            <Button size="lg" className="bg-secondary text-white hover:bg-secondary/90 h-14 px-10 text-lg shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]" asChild>
              <Link href="/discover">
                Start Exploring <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="bg-transparent text-white border-white/30 hover:bg-white/10 h-14 px-10 text-lg hover:border-white transition-all hover:scale-[1.02]" >
              Partner with Us
            </Button>
          </motion.div>
        </motion.div>
