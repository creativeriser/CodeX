                        ...
                        <div className="grid gap-3">
                            ...
                            >
                                <div className="w-12 h-12 rounded-xl bg-sky-50 text-sky-600 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform duration-300 shadow-sm">
                                    {/* Professional Custom Grad Cap Icon */}
                                    <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    >
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-xs text-slate-500 mt-1">
                                {activeRole === "faculty" ? "Use your university credentials" : "Enter your student ID to continue"}
                            </p>
                        </div>
                        ...
                        <div className="space-y-5">
                            ...
                            >
                                Continue <ArrowRight className="w-3.5 h-3.5 ml-2 opacity-80" />
                            </Button>
