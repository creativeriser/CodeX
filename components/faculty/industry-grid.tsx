    ...
    return (
        <div className="py-2">
            ...
            <div id="discovery" className="flex flex-col gap-4 mb-8">
                <div>
                    <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Broad Discovery</h2>
                    <p className="text-sm text-slate-500 font-medium">Explore sites mapped to other faculties</p>
                </div>
